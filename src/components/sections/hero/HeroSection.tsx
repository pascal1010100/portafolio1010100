...
export function HeroSection() {
  return (
    <section id="home" className="relative isolate overflow-hidden border-b border-white/10 pt-20">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center px-4 py-12 sm:px-6 sm:py-16 lg:px-8 xl:min-h-[calc(100vh-6rem)] xl:grid-cols-[0.95fr_1.05fr] xl:py-8">
        <motion.div
          initial={false}
        ...
        >
          <div className="mb-5 flex items-center gap-3 text-[10px] font-medium uppercase tracking-[0.18em] text-white/50 sm:mb-6 sm:text-xs sm:tracking-[0.2em]">
          ...
          <h1 className="max-w-4xl text-[2.55rem] font-medium leading-[0.98] tracking-[-0.055em] text-white min-[380px]:text-5xl sm:text-6xl lg:text-[4.15rem] xl:text-[4.35rem] 2xl:text-[4.65rem]">
            Diseño productos digitales que se sienten inevitables.
          </h1>

          <p className="mt-5 max-w-2xl text-base leading-7 text-white/58 sm:mt-6 sm:text-lg sm:leading-8">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row">
            ...
            <Link href="#contact" className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/[0.025] px-6 py-3.5 text-sm font-medium text-white/82 transition hover:border-white/35 hover:bg-white/[0.055] hover:text-white">
              Cuéntame tu idea
            </Link>
          </div>

          <div className="mt-7 flex flex-wrap items-center gap-x-4 gap-y-3 border-t border-white/10 pt-5 text-xs text-white/45 sm:mt-9 sm:gap-x-5 sm:pt-5 sm:text-sm">
        ...
        <motion.div
          ...
          className="relative -mx-2 mt-2 h-[17rem] sm:mx-0 sm:mt-0 sm:h-[28rem] lg:h-[32rem] xl:-ml-10 xl:mr-[-3rem] xl:-mt-20 xl:h-[36rem] 2xl:mr-[-5rem] 2xl:-mt-24 2xl:h-[39rem]"
